  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Corona del Monarca',
        'Escama de Drake Cendrillero',
        'Piedra del Corazón Alasoscura',
        'Brasa Maligna',
        'Hombreras de Hueso de Drake',
        'Capucha Alasoscura',
        'Capucha del Acechador Maligno',
        'Espadón de Ignaraxis',
        'Báculo de Cenizas Eternas',
        'Colmillo de Ignaraxis',
      ]),
    },
  },
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Écaille de Drake Cendremarcheur',
        'Pierre de Coeur Brûleaile',
        'Braise Maudite',
        'Épaulières en Os de Drake',
        'Cagoule Brûleaile',
        'Cagoule du Rôdeur Maudit',
        "Grand Glaive d'Ignaraxis",
        'Sceptre de Cendres Éternelles',
        "Croc d'Ignaraxis",
      ]),
    },
  },
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Corona del Monarca',
        'Scaglia del Drake Cenerepassante',
        'Pietra del Cuore Alacenere',
        'Brace Maledetta',
        "Spalline d'Osso di Drake",
        'Cappuccio Alacenere',
        'Cappuccio del Predatore Maledetto',
        'Granspadone di Ignaraxis',
        'Bastone di Cenere Eterna',
        'Zanna di Ignaraxis',
      ]),
    },
  },
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Dornhaut-Wams',
        'Krone des Monarchen',
        'Aschläufer-Drachenschuppe',
        'Gluthschwingen-Herzstein',
        'Seuchenglut',
        'Drachenknochen-Schulterplatten',
        'Gluthschwingen-Kappe',
        'Seuchen-Späher-Kappe',
        'Ignaraxis-Großschwert',
        'Zünderstab der Ewigen',
        'Zahn des Ignaraxis',
      ]),
    },
  },
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Coroa do Monarca',
        'Escama do Drake Cinzeiro',
        'Pedra do Coração Asaquente',
        'Brasa Maldita',
        'Ombreiras de Osso de Drake',
        'Capuz Asaquente',
        'Capuz do Perseguidor Maldito',
        'Espadão de Ignaraxis',
        'Cajado de Cinzas Eternas',
        'Presa de Ignaraxis',
      ]),
    },
  },
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Корона Монарха',
        'Чешуя Пепельного Дрейка',
        'Сердечный камень Выжигокрыла',
        'Скверна-Уголёк',
        'Наплечники из кости Дрейка',
        'Капюшон Выжигокрыла',
        'Капюшон Скверного Следопыта',
        'Великий Клинок Игнараксиса',
        'Посох Вечного Пепла',
        'Клык Игнараксиса',
      ]),
    },
